...
## Environments
- Preview: https://main--xwalk-starter-site--timwlee.aem.page/
- Live: https://main--xwalk-starter-site--timwlee.aem.live/
...
1. Open the `xwalk-starter-site` directory in your favorite IDE and start coding :)
